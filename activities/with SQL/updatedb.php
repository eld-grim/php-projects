...
<body>
    <form method="post" action="updatedbOut.php">
        <h2>Update Database Entry</h2>
        Select ID from Database: <input type="number" name="idDB" required /></br>
        Enter New Name: <input type="text" name="newName" required /></br>
        Enter New Address: <textarea name="newAdd" required> </textarea> </br>
        Enter New Email Address: <input type="email" name="newEAdd" required /></br>
        Enter New Contact Number: <input type="number" name="newconNum" required /></br>
        Enter New Address Landmark: <textarea name="newAddLnd" required> </textarea></br>
