...
<head>
    ...
    <title>Search Database Results</title>
</head>

<body>
    <a href="searchdb.php">Search Again</a></br>
    <a href="homepage.php">Go Back to Menu</a></br>
    <table border="1" cellpadding="1" cellspacing="1">
        ...
        $search = mysqli_real_escape_string($conn, $_POST['fname']);
        $sql = "SELECT * FROM sptbl WHERE cusN LIKE '%$search%' OR cusAdr LIKE '%$search%' OR cusEad LIKE '%$search%'
        OR cusNum LIKE '%$search%' OR cusAdrLnd LIKE '%$search%' OR delRte LIKE '%$search%' OR delDes LIKE '%$search%' OR delSchd LIKE '%$search%' OR delScht LIKE '%$search%' OR amtPR LIKE '%$search%' OR delCt LIKE '%$search%' OR cPay LIKE '%$search%' OR chg LIKE '%$search%' OR tFuelcns LIKE '%$search%' OR tFuelct LIKE '%$search%'";
